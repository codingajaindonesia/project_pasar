...
class IncomeDetailController extends Controller
{
    ...
    public function index(Request $request, $id)
    {
        ...
        return view('contents/transactions/income/detail/index', compact('transactions', 'id'));
    }
    ...
    {
        $categories = Category::where('types', 'in')->get();
        return view('contents/transactions/income/detail/_form', compact('categories', 'id'));
    }
    ...
    public function store(Request $request, $id)
    {
       try {
        ...
        return redirect('transactions-income/'. $id.'/detail/')->with('success', 'Transaction detail created successfully.');
       } catch (\Throwable $th) {
    ...
    public function edit(Request $request, $id, string $detailID)
    {
        ...
        $categories = Category::where('types', 'in')->get();
        return view('contents/transactions/income/detail/_form', compact('transaction', 'categories', 'id'));
    }
    ...
    public function update(Request $request, $id, string $detailID)
    {
        try {
            ...
            return redirect('transactions-income/'. $id.'/detail/')->with('success', 'Transaction detail updated successfully.');
        } catch (\Throwable $th) {
